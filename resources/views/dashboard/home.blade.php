            ...
            <div class="container">
                ...
                <div class="row align-items-stretch">
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up">
                        ...
                        <div class="unit-4 d-block">
                            <div class="unit-4-icon mb-3">
                                <span class="icon-wrap"><span class="text-primary icon-directions_walk"></span></span>
                            </div>
                            <div>
                                <h3>Perjalanan</h3>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up">
                        <div class="unit-4 d-block">
                            <div class="unit-4-icon mb-3">
                                <span class="icon-wrap"><span class="text-primary icon-account_circle"></span></span>
                            </div>
                            <div>
                                <h3>Profil</h3>
                                <p>Untuk melihat data diri anda dan bisa mengubah data diri anda jika tidak sesuai</p>
                                <div>
                                    <a href="/profil/edit/{{ auth()->user()->id }}" class="btn btn-primary mr-2 mb-2">Get Started</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up">
                        <div class="unit-4 d-block">
                            <div class="unit-4-icon mb-3">
                                <span class="icon-wrap"><span class="text-primary icon-import_contacts"></span></span>
                            </div>
                            <div>
                                <h3>Data User</h3>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up">
                        <div class="unit-4 d-block">
                            <div class="unit-4-icon mb-3">
                                <span class="icon-wrap"><span class="text-primary icon-print"></span></span>
                            </div>
                            <div>
                                <h3>Print</h3>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 aos-init aos-animate" data-aos="fade-up">
                        <div class="unit-4 d-block">
                            <div class="unit-4-icon mb-3">
                                <span class="icon-wrap"><span class="text-primary icon-power_settings_new"></span></span>
                            </div>
                            <div>
                                <h3>Keluar</h3>
